        ...
        <div className="home" style={{ color:"#ffffff", textAlign:"center" }} >
            ...
            <Block hover={true} style={{width:"50vw",minWidth:"600px", maxWidth:"100%", margin:"auto", textAlign:"left",paddingLeft:"2.5vw", paddingTop:"2.5vh", display:"flex", justifyContent:"space-between", marginBlock:"5vh", }}>
                <div style={{marginRight:"2.5vw"}}>
                    ...
                    <br></br>
                    <div style={{display:"flex", marginTop:"2vh",  flexWrap: 'wrap'}}>
                        <div>Made with: </div>
                    ...
                    Developed a DBaaS (Database-as-a-Service) platform using a Java Spring Boot control plane to manage containerized PostgreSQL & MongoDB. This system automates instance lifecycle via REST APIs: provisioning, backups (manual & scheduled e.g., hourly, daily), restore, and cloning. Engineered with an extensible DatabaseProvider interface design for multi-DB support using docker-java, secured by JWT/RBAC, and streams key performance metrics (CPU, memory, DB stats) in real-time via Socket.IO.
                    </span>
                    <div>
                        ...
                        <button style={{position:"sticky",bottom:0, marginBlock:"2vh",backgroundColor:"#fff", color:"#000",borderRadius:"50px", border:"0" }} onClick={() => {window.open('https://tndb.tejasnavada.com/');}}>
...
dialog::backdrop {
  ...
  backdrop-filter: blur(1px);
                ...
                <img style={{borderRadius:"10px", margin:"auto",marginLeft:"2.5vw",minWidth:"50%", objectFit:"contain", width:"auto", height:"auto"}}  src="TNDBDEMO.gif"></img>
            </Block>
